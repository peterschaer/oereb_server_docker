...
**It is representing the topic: Regional Land Use Plans**
...
class Availability(Base):
    ...
    """
    __table_args__ = {'schema': 'regional_land_use_plans'}
...
class DataIntegration(Base):
    ...
    Attributes:
        ...
        office (pyramid_oereb.standard.models.regional_land_use_plans.Office):
...
class ReferenceDefinition(Base):
    ...
    Attributes:
        ...
        responsible_office (pyramid_oereb.standard.models.regional_land_use_plans.Office):
...
class Article(DocumentBase):
    ...
    Attributes:
        ...
        document_id (pyramid_oereb.standard.models.regional_land_use_plans.Document):
...
class LegendEntry(Base):
    ...
    :class:`pyramid_oereb.standard.models.regional_land_use_plans.ViewService`.
    ...
    Attributes:
        ...
        view_service (pyramid_oereb.standard.models.regional_land_use_plans.ViewService):
...
class Geometry(Base):
    ...
    Attributes:
        ...
        public_law_restriction_id (int): The foreign key to the public law restriction this geometry
            is  related to.
        public_law_restriction (pyramid_oereb.standard.models.regional_land_use_plans
...
class PublicLawRestrictionBase(Base):
    ...
    Attributes:
        ...
        plr (pyramid_oereb.standard.models.regional_land_use_plans.PublicLawRestriction):
            The dedicated relation to the public law restriction (which bases on) instance from  database.
        base (pyramid_oereb.standard.models.regional_land_use_plans.PublicLawRestriction):
...
class PublicLawRestrictionDocument(Base):
    ...
    Attributes:
        ...
        document (pyramid_oereb.standard.models.regional_land_use_plans.DocumentBase):
            The dedicated relation to the document instance from database.
    """
...
class DocumentReference(Base):
    ...
    Attributes:
        ...
        document (pyramid_oereb.standard.models.regional_land_use_plans.Document):
            The dedicated relation to the document (which references) instance from database.
        referenced_document (pyramid_oereb.standard.models.regional_land_use_plans.Document):
