...
**It is representing the topic: Regional protected botanical objects**
...
class Availability(Base):
    ...
    """
    __table_args__ = {'schema': 'regional_protected_botanical_objects'}
...
class DataIntegration(Base):
    ...
    Attributes:
        ...
        office (pyramid_oereb.standard.models.regional_protected_botanical_objects.Office):
...
class ReferenceDefinition(Base):
    ...
    Attributes:
        ...
        responsible_office (pyramid_oereb.standard.models.regional_protected_botanical_objects.Office):
...
class Article(DocumentBase):
    ...
    Attributes:
        ...
        document_id (pyramid_oereb.standard.models.regional_protected_botanical_objects.Document):
...
class LegendEntry(Base):
    ...
    :class:`pyramid_oereb.standard.models.regional_protected_botanical_objects.ViewService`.
    ...
    Attributes:
        ...
        view_service (pyramid_oereb.standard.models.regional_protected_botanical_objects.ViewService):
...
class Geometry(Base):
    ...
    Attributes:
        ...
        public_law_restriction_id (int): The foreign key to the public law restriction this geometry
            is  related to.
        public_law_restriction (pyramid_oereb.standard.models.regional_protected_botanical_objects
...
class PublicLawRestrictionBase(Base):
    ...
    Attributes:
        ...
        plr (pyramid_oereb.standard.models.regional_protected_botanical_objects.PublicLawRestriction):
            The dedicated relation to the public law restriction (which bases on) instance from  database.
        base (pyramid_oereb.standard.models.regional_protected_botanical_objects.PublicLawRestriction):
...
class PublicLawRestrictionDocument(Base):
    ...
    Attributes:
        ...
        document (pyramid_oereb.standard.models.regional_protected_botanical_objects.DocumentBase):
            The dedicated relation to the document instance from database.
    """
...
class DocumentReference(Base):
    ...
    Attributes:
        ...
        document (pyramid_oereb.standard.models.regional_protected_botanical_objects.Document):
            The dedicated relation to the document (which references) instance from database.
        referenced_document (pyramid_oereb.standard.models.regional_protected_botanical_objects.Document):
